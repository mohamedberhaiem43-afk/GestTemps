...
function EcheanceContrat() {
  // Initialize with properly formatted dates
  ...
  const columns = useMemo<MRT_ColumnDef<EchContrat>[]>(() => [
    ...
    async function handleApplyFilter(): Promise<void> {
      ...
      try {
        // Format dates properly before API call
  ...
  return (
    ...
    <Container>
        ...
        <Typography variant="h6" fontWeight={'bold'} color={'primary'}>Echéance Contrat</Typography>
        ...
        <Grid mt={3}>
          <DataList data={contrats} columns={columns} message={undefined} deleteMethod={undefined}
            ...
            reportGeneration3={undefined} reportGeneration4={undefined} empHoraires={undefined} setData={undefined}
            pageSize={5} purge={undefined} />
        </Grid>
      </Box>
    </Container>
    </>
