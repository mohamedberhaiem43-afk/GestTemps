    ...
    public static class ServicesRegistration
    {
        public static void AddServicesRegistration(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<Kernel>(sp =>
            {
                ...
                var openRouterModel = config["OpenRouter:ChatModel"] ?? "google/gemma-4-31b-it:free";
            ...
            builder.Services.AddScoped<ABRPOINT.Server.Services.Signature.ISignatureOtpService, ABRPOINT.Server.Services.Signature.SignatureOtpService>();
