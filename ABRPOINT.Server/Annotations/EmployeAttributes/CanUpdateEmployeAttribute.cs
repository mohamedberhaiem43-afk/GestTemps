...
{
    public class CanUpdatetEmployeAttribute : TypeFilterAttribute
    {
        public CanUpdatetEmployeAttribute() : base(typeof(CanUpdateEmployeFilter))
        {
        }
        public class CanUpdateEmployeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanUpdateEmployeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
