...
{
    public class CanDeleteEmployeAttribute : TypeFilterAttribute
    {
        public CanDeleteEmployeAttribute() : base(typeof(CanDeleteEmployeFilter))
        {
        }
        public class CanDeleteEmployeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanDeleteEmployeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
