...
{
    public class CanGetCahierCongeAttribute : TypeFilterAttribute
    {
        public CanGetCahierCongeAttribute() : base(typeof(CanGetCahierCongeFilter))
        {
        }
        public class CanGetCahierCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanGetCahierCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
            public void OnAuthorization(AuthorizationFilterContext context)
            {
                ...
                var hasPermission = _context.Modusers.Any(m =>
                    m.Uticod == userUticod &&
                    m.Modcod == "dec_conge" &&   // module code for "employe"
