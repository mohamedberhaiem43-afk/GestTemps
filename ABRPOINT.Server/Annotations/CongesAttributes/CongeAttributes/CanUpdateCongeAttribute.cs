...
{
    public class CanUpdateCongeAttribute : TypeFilterAttribute
    {
        public CanUpdateCongeAttribute() : base(typeof(CanUpdateCongeFilter))
        {
        }
        public class CanUpdateCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanUpdateCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
