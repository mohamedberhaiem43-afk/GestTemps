...
{
    public class CanGetCongeAttribute : TypeFilterAttribute
    {
        public CanGetCongeAttribute() : base(typeof(CanGetCongeFilter))
        {
        }
        public class CanGetCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanGetCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
