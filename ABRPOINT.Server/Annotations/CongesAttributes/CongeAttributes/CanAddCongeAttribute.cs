...
{
    public class CanAddCongeAttribute : TypeFilterAttribute
    {
        public CanAddCongeAttribute() : base(typeof(CanAddCongeFilter))
        {
        }
        public class CanAddCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanAddCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
