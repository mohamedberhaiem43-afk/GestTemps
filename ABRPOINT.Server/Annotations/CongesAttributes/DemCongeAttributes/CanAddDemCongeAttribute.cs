...
{
    public class CanAddDemCongeAttribute : TypeFilterAttribute
    {
        public CanAddDemCongeAttribute() : base(typeof(CanAddDemCongeFilter))
        {
        }
        public class CanAddDemCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanAddDemCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
