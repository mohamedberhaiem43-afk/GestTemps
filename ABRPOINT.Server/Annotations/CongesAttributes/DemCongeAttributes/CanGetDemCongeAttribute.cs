...
{
    public class CanGetDemCongeAttribute : TypeFilterAttribute
    {
        public CanGetDemCongeAttribute() : base(typeof(CanGetDemCongeFilter))
        {
        }
        public class CanGetDemCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanGetDemCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
