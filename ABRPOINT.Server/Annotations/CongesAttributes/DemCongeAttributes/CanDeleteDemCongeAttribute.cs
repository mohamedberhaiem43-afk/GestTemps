...
{
    public class CanDeleteDemCongeAttribute : TypeFilterAttribute
    {
        public CanDeleteDemCongeAttribute() : base(typeof(CanDeleteDemCongeFilter))
        {
        }
        public class CanDeleteDemCongeFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanDeleteDemCongeFilter(ApplicationDbContext context)
            {
                _context = context;
            }
