...
{
    public class CanAddEtatPeriodiqueAttribute : TypeFilterAttribute
    {
        public CanAddEtatPeriodiqueAttribute() : base(typeof(CanAddEtatPeriodiqueFilter))
        {
        }
        public class CanAddEtatPeriodiqueFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanAddEtatPeriodiqueFilter(ApplicationDbContext context)
            {
                _context = context;
            }
