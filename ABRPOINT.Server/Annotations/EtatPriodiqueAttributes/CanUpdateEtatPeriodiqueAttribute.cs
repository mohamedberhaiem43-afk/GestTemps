...
{
    public class CanUpdateEtatPeriodiqueAttribute : TypeFilterAttribute
    {
        public CanUpdateEtatPeriodiqueAttribute() : base(typeof(CanUpdateEtatPeriodiqueFilter))
        {
        }
        public class CanUpdateEtatPeriodiqueFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanUpdateEtatPeriodiqueFilter(ApplicationDbContext context)
            {
                _context = context;
            }
