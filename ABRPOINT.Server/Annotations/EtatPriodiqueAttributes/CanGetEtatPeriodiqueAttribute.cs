...
{
        public class CanGetEtatPeriodiqueAttribute : TypeFilterAttribute
        {
            public CanGetEtatPeriodiqueAttribute() : base(typeof(CanGetEtatPeriodiqueFilter))
            {
            }
            public class CanGetEtatPeriodiqueFilter : IAuthorizationFilter
            {
                private readonly ApplicationDbContext _context;
                public CanGetEtatPeriodiqueFilter(ApplicationDbContext context)
                {
                    _context = context;
                }
