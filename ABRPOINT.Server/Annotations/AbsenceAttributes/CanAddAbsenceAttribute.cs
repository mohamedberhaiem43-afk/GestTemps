...
{
    public class CanAddAbsenceAttribute : TypeFilterAttribute
    {
        public CanAddAbsenceAttribute() : base(typeof(CanAddAbsenceFilter))
        {
        }
        public class CanAddAbsenceFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanAddAbsenceFilter(ApplicationDbContext context)
            {
                _context = context;
            }
