...
{
    public class CanGetAbsenceAttribute : TypeFilterAttribute
    {
        public CanGetAbsenceAttribute() : base(typeof(CanGetAbsenceFilter))
        {
        }
        public class CanGetAbsenceFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetAbsenceFilter(ApplicationDbContext context)
            {
                _context = context;
            }
