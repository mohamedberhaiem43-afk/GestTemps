...
{
    public class CanGetPointeuseAttribute : TypeFilterAttribute
    {
        public CanGetPointeuseAttribute() : base(typeof(CanGetPointeuseFilter))
        {
        }
        public class CanGetPointeuseFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetPointeuseFilter(ApplicationDbContext context)
            {
                _context = context;
            }
