...
{
    public class CanPurgePointeuseAttribute : TypeFilterAttribute
    {
        public CanPurgePointeuseAttribute() : base(typeof(CanPurgePointeuseFilter))
        {
        }
        public class CanPurgePointeuseFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanPurgePointeuseFilter(ApplicationDbContext context)
            {
                _context = context;
            }
            ...
            public void OnAuthorization(AuthorizationFilterContext context)
            {
                ...
                var hasPermission = _context.Modusers.Any(m =>
                    m.Uticod == userUticod &&
                    m.Modcod == "ppimp" &&   // module code for "Ferie"
