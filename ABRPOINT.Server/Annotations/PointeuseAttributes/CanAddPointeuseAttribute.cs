...
{
    public class CanAddPointeuseAttribute : TypeFilterAttribute
    {
        public CanAddPointeuseAttribute() : base(typeof(CanAddPointeuseFilter))
        {
        }
        public class CanAddPointeuseFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanAddPointeuseFilter(ApplicationDbContext context)
            {
                _context = context;
            }
