...
{
    public class CanDeletePointeuseAttribute : TypeFilterAttribute
    {
        public CanDeletePointeuseAttribute() : base(typeof(CanDeletePointeuseFilter))
        {
        }
        public class CanDeletePointeuseFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanDeletePointeuseFilter(ApplicationDbContext context)
            {
                _context = context;
            }
