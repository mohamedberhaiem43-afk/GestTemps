...
{
    public class CanAddAutSortieAttribute : TypeFilterAttribute
    {
        public CanAddAutSortieAttribute() : base(typeof(CanAddAutorisationsFilter))
        {
        }
        public class CanAddAutorisationsFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanAddAutorisationsFilter(ApplicationDbContext context)
            {
                _context = context;
            }
