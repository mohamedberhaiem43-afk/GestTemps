...
{
    public class CanGetFerieAttribute : TypeFilterAttribute
    {
        public CanGetFerieAttribute() : base(typeof(CanGetFerieFilter))
        {
        }
        public class CanGetFerieFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetFerieFilter(ApplicationDbContext context)
            {
                _context = context;
            }
            ...
            public void OnAuthorization(AuthorizationFilterContext context)
            {
                ...
                var hasPermission = _context.Modusers.Any(m =>
                    ...
                    m.Modconsult == "1"         // allow get (saisie)
                );
