...
{
    public class CanGetEtatPointageAttribute : TypeFilterAttribute
    {
        public CanGetEtatPointageAttribute() : base(typeof(CanGetEtatPointageFilter))
        {
        }
        public class CanGetEtatPointageFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanGetEtatPointageFilter(ApplicationDbContext context)
            {
                _context = context;
            }
