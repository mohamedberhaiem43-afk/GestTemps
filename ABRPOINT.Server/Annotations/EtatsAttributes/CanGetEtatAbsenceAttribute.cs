...
{
    public class CanGetEtatAbsenceAttribute : TypeFilterAttribute
    {
        public CanGetEtatAbsenceAttribute() : base(typeof(CanGetEtatAbsenceFilter))
        {

        }
        public class CanGetEtatAbsenceFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetEtatAbsenceFilter(ApplicationDbContext context)
            {
                _context = context;
            }
            ...
            public void OnAuthorization(AuthorizationFilterContext context)
            {
                ...
                var hasPermission = _context.Modusers.Any(m =>
                    m.Uticod == userUticod &&
                    m.Modcod == "etat_abs" &&   // module code for "etat absence"
