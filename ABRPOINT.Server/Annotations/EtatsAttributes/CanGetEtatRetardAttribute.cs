...
{
    public class CanGetEtatRetardAttribute : TypeFilterAttribute
    {
        public CanGetEtatRetardAttribute() : base(typeof(CanGetEtatRetardFilter))
        {

        }
        public class CanGetEtatRetardFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetEtatRetardFilter(ApplicationDbContext context)
            {
                _context = context;
            }
            ...
            public void OnAuthorization(AuthorizationFilterContext context)
            {
                ...
                var hasPermission = _context.Modusers.Any(m =>
                    m.Uticod == userUticod &&
                    m.Modcod == "etat_ret" &&   // module code for "etat retard"
