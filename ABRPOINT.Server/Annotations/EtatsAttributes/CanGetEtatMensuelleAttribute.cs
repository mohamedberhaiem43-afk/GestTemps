...
{
    public class CanGetEtatMensuelleAttribute : TypeFilterAttribute
    {
        public CanGetEtatMensuelleAttribute() : base(typeof(CanGetEtatMensuelleFilter))
        {

        }
        public class CanGetEtatMensuelleFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetEtatMensuelleFilter(ApplicationDbContext context)
            {
                _context = context;
            }
            ...
            public void OnAuthorization(AuthorizationFilterContext context)
            {
                ...
                var hasPermission = _context.Modusers.Any(m =>
                    m.Uticod == userUticod &&
                    m.Modcod == "etat_mens" &&   // module code for "etat mensuelle"
