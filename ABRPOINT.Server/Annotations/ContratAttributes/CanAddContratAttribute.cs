...
{
    public class CanAddContratAttribute : TypeFilterAttribute
    {
        public CanAddContratAttribute() : base(typeof(CanAddContratFilter))
        {
        }
        public class CanAddContratFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanAddContratFilter(ApplicationDbContext context)
            {
                _context = context;
            }
