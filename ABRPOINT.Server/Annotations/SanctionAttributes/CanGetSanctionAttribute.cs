...
{
    public class CanGetSanctionAttribute : TypeFilterAttribute
    {
        public CanGetSanctionAttribute() : base(typeof(CanGetSanctionFilter))
        {
        }
        public class CanGetSanctionFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;

            public CanGetSanctionFilter(ApplicationDbContext context)
            {
                _context = context;
            }
