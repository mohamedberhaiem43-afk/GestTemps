...
{
    public class CanUpdateAllaitementAttribute : TypeFilterAttribute
    {
        public CanUpdateAllaitementAttribute() : base(typeof(CanUpdateAllaitementFilter))
        {
        }
        public class CanUpdateAllaitementFilter : IAuthorizationFilter
        {
            private readonly ApplicationDbContext _context;
            public CanUpdateAllaitementFilter(ApplicationDbContext context)
            {
                _context = context;
            }
