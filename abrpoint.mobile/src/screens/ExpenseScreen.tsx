...
const styles = StyleSheet.create({
  ...
  logoText: { fontFamily: 'Manrope', fontWeight: '800', fontSize: 18, color: COLORS.primary, trackingTight: -0.5 },
  ...
  uploadArea: { borderSize: 2, borderStyle: 'dashed', borderColor: COLORS.outlineVariant, borderRadius: 16, padding: 32, alignItems: 'center', gap: 12, backgroundColor: COLORS.surfaceContainerLowest },
